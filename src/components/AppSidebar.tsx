import { BarChart3, Home, TrendingUp, Sun, Moon, IndianRupee, Layers, BookOpen } from "lucide-react";
...
const navItems = [
  { title: "The Ledger", url: "/", icon: Home },
  { title: "Narrative Story", url: "/narrative", icon: BookOpen },
